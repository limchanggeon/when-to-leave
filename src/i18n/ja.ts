...
export const ja: I18nShape = {
  ...
  emailAuth: {
    ...
    passwordProblem: {
      'too-long': 'パスワードが長すぎます（128文字以下）',
      'too-common': 'よく使われるパスワードです',
      'too-simple': '連続や繰り返しだけでは設定できません',
      'looks-like-email': 'メールアドレスに似すぎています',
    },
    password2: 'パスワード確認',
    ...
    checkGoLogin: 'ログインする',
    sentTitle: '確認メールをご確認ください',
    sentHint: '受信トレイと迷惑メールをご確認ください。リンクは24時間有効です。開くと登録が完了します。アプリでは確認後に再度ログインしてください。',
  ...
  verifyNotice: {
    pending: 'メールアドレスの確認が完了しました。管理者の承認なしで、メールアドレスとパスワードでログインできます。',
