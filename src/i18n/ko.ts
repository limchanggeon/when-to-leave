...
export const ko = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        h: '광고',
        /* 광고를 실제로 달았을 때만 보인다 — 안 하는 일을 방침에 적지 않는다 */
        ads: true,
        body: [
          '서버 비용을 대려고 구글 애드센스를 씁니다.',
          '광고(구글 애드센스)는 로그인 쿠키와 별도의 쿠키를 쓸 수 있습니다.',
          '광고를 받아올 때 브라우저가 구글 광고 서버에 직접 연결합니다.',
      ...
      },
      {
        ...
        rows: [
          ...
          ['구글 (폰트)', '글꼴을 받아올 때 브라우저가 직접 연결합니다'],
  ...
  footer: {
    ...
    /** 광고를 아직 안 달았을 때. 안 하는 일을 한다고 적지 않는다. */
    nonprofitNoAds: '개인이 만들어 운영합니다',
    disclaimer:
