...
export const ko = {
  ...
  emailAuth: {
    ...
    checkGoLogin: '로그인하기',
    sentTitle: '인증 메일을 확인해 주세요',
    sentHint: '입력한 주소의 받은편지함과 스팸함을 확인해 주세요. 인증 링크는 24시간 동안 유효하며, 누르면 가입이 완료됩니다. 앱에서는 인증 후 다시 로그인해 주세요.',
  ...
  verifyNotice: {
    pending: '이메일 확인 절차가 끝났습니다. 관리자 승인 없이 이메일과 비밀번호로 로그인할 수 있습니다.',
